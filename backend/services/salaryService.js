...
// 🔥 ALWAYS TRUST PRE-CALCULATED VALUE
...
// 🔥 IMPORTANT: remove ALH from present
const purePresent = totalPresent - totalALH;
...
console.log("FINAL DATA DEBUG:", {
  al: finalData.al,
  daysWorked: finalData.daysWorked,
  daysPaid: finalData.daysPaid
});

// 🔥 Recompute correctly
const computed = computeDerivedFields(finalData, existingSalary ? existingSalary._doc : {});

// 🔥 Preserve AL explicitly
computed.al = finalData.al;
computed.AL = finalData.AL;
computed.daysPaid = finalData.daysPaid;
