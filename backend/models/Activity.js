...
// 🔥 FIXED UNIQUE INDEX (CRITICAL)
activitySchema.index(
  { empId: 1, empUnit: 1, date: 1 },
  { unique: true }
);
...
// 🔍 Fast lookup of modified rows
activitySchema.index({ isStatusModified: 1 });

// 🔥 Optional: Unit-based filtering (recommended)
activitySchema.index({ empUnit: 1, date: -1 });
